...
echo "use_model: DelayedEmbeddingLinearModelMultiFeature"
echo "predict_fmri_absolute: False"
...
python train_analyze_fmri_potter.py \
    ...
    --random $random_index\
    --use_model DelayedEmbeddingLinearModelMultiFeature
...
echo "llm_model_index: $llm_model_index"
echo "use_model: DelayedEmbeddingLinearModelMultiFeature"
echo "predict_fmri_absolute: True"
# Run the Python script with the selected parameters
python train_analyze_fmri_potter.py \
    --n_top_pc_llm $n_top_pc_llm \
    --weight_decay $weight_decay \
...
python train_analyze_fmri_potter.py \
    ...
    --llm_model_index $llm_model_index \
    --random $random_index\
    --use_model DelayedEmbeddingLinearModelOneFeature
